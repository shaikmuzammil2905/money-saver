      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs flex items-center gap-1.5 transition-colors border border-slate-200"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-4 py-2 rounded-xl bg-[#008744] hover:bg-emerald-600 text-white font-bold text-xs flex items-center gap-1.5 shadow-sm transition-colors"
            >
        ...
        <div className="bg-amber-50 p-4 rounded-xl border border-amber-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-xs font-black uppercase text-amber-800 tracking-wider block">Dashboard Date Calendar Filter</span>
              {selectedDateFormatted ? (
                <span className="text-sm font-black text-amber-900">
                  Selected Date: {selectedDateFormatted}
                </span>
              ) : (
                <span className="text-xs text-amber-700 font-medium">Viewing all real database statistics (No specific date selected)</span>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="bg-white text-slate-900 text-xs font-bold rounded-xl py-2 px-3 border border-amber-300 cursor-pointer focus:outline-none focus:border-amber-500"
            />
            {selectedDate && (
              <button
                onClick={() => setSelectedDate('')}
                className="px-3 py-2 rounded-xl bg-red-50 text-red-700 border border-red-200 text-xs font-bold hover:bg-red-100 transition-colors"
              >
                Reset Date
              </button>
            )}
        ...
        {stats.map((stat, idx) => {
          ...
          return (
            <div
              ...
              className="bg-white border border-slate-200 hover:border-slate-300 rounded-2xl p-4 sm:p-5 shadow-sm hover:shadow-md cursor-pointer transition-all hover:scale-[1.02] group"
            >
              ...
              <h3 className="text-xs font-bold text-slate-500 mt-1 flex items-center justify-between group-hover:text-slate-900 transition-colors">
